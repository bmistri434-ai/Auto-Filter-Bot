...
ADMINS = [
    ...
    for admin in environ.get("ADMINS", "8125168496").split()
]
OWNER_USERNAME = environ.get(
    "OWNER_USERNAME", "joydeep_1445"
)  # without @ or https://t.me/
USERNAME = environ.get("USERNAME", "joydeep_1445")  # ADMIN USERNAME

# Database Channel
CHANNELS = [
    int(ch) if id_pattern.search(ch) else ch
    for ch in environ.get("CHANNELS", "-1002913051746 -1003001499416").split()
]

# ForceSub Channel & Log Channels
AUTH_CHANNEL = int(environ.get("AUTH_CHANNEL", "-1002911505336"))
AUTH_REQ_CHANNEL = int(environ.get("AUTH_REQ_CHANNEL", "-1002911505336"))
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1003005357865"))
LOG_API_CHANNEL = int(environ.get("LOG_API_CHANNEL", "-1003005357865"))
LOG_VR_CHANNEL = int(environ.get("LOG_VR_CHANNEL", "-1003005357865"))

# MongoDB
DATABASE_URI = environ.get("DATABASE_URI", "mongodb+srv://joydeep1451:joydeep1451@cluster0.zwjzz5v.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get("DATABASE_NAME", "Cluster0")

# Files index database url
FILES_DATABASE = environ.get("FILES_DATABASE", "mongodb+srv://joydeep1451:joydeep1451@cluster0.prhptdx.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
COLLECTION_NAME = environ.get("COLLECTION_NAME", "jisshu")

# Other Channel's
SUPPORT_GROUP = int(environ.get("SUPPORT_GROUP", "-1003190810468"))
DELETE_CHANNELS = int(environ.get("DELETE_CHANNELS", "-1003005357865"))
request_channel = environ.get("REQUEST_CHANNEL", "-1003126148086")
REQUEST_CHANNEL = (
    int(request_channel)
    if request_channel and id_pattern.search(request_channel)
    else None
)
MOVIE_UPDATE_CHANNEL = int(environ.get("MOVIE_UPDATE_CHANNEL", "-1002911505336"))

# Added Link Here Not Id
SUPPORT_CHAT = environ.get("SUPPORT_CHAT", "https://t.me/opmoviessupport")
MOVIE_GROUP_LINK = environ.get("MOVIE_GROUP_LINK", "https://t.me/opmoviesworld")
...
PAYPICS = (
    environ.get("PAYPICS", "https://envs.sh/1Xq.jpg")
).split()
